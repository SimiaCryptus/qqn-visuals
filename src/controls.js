...
export class GlobalControls extends EventTarget {
    ...
    _wire() {
        ...
        // transport
        document.getElementById('transport-step').addEventListener('click',
            () => this._emit('transport', {action: 'step'}));
        document.getElementById('transport-play').addEventListener('click',
            () => this._emit('transport', {action: 'play'}));
        document.getElementById('transport-reset').addEventListener('click',
            () => this._emit('transport', {action: 'reset'}));
